...
TheeDiscordMCP is a privileged operator. Treat its bot token like a password.
...
- Keep the generated `.data/state.json` private. It contains resource IDs, not the bot token, and supports idempotent blueprint runs.
